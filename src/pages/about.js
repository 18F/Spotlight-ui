...
const SecondPage = () => (
  ...
  <p>We believe excellent federal websites lead to the delivery of excellent digital services for the public and public servants. We built Site Scanner as a reference tool you use to instantly access data on the big picture of what's working really well on federal websites. Data indicating the most critical web hygiene and user-friendly features present on a federal website. These top features of excellence are distilled from industry standards, federal laws, and user needs. Site Scanner aims to help you determine which particular features lead to successful federal websites so you can best prioritize your resources.</p>
 
  <p>Site Scanner is an open-source tool that runs on <a ref="https://cloud.gov/">cloud.gov</a>. The core of Site Scanner is a scanning engine that performs a series of scans that each check for a particular feature on each individual website included in a continously-updated list of federal domains and subdomains. Some scans are run using a plug-in called <a ref="https://developers.google.com/web/tools/lighthouse">Google Lighthouse</a>. Others are run using custom code. Scanning happens each night and takes about 4 minutes to complete. Then, Site Scanner compiles all the scan results into simple data files called <a ref="https://www.json.org/json-en.html">JSON</a>.To access the data in these JSON files, users pull the data into their own system by using the Site Scanner API, or by engaging directly on the Site Scanner results page. You can explore further into our code on <a ref="https://github.com/18F/site-scanning">Site Scanner's public Github repository</a>.</p>
